/* ------------------------------------------------------------------ */
/* Shared provider brand marks (official SVGs, single source of truth)  */
/* ------------------------------------------------------------------ */
...
/* GLM = z.ai official mark, locked to our forest primary color */
export function GLMLogo({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" fillRule="evenodd" className={`text-forest ${className}`} aria-hidden>
...
export function KimiLogo({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden>
